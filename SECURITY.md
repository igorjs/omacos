...
- **GitHub Security Advisories**: [Report a vulnerability](https://github.com/igorjs/omacos/security/advisories/new)
...
Only the latest released version (`v1.0.0`) receives security patches. Upgrade to the latest version before reporting.
